...
if __name__ == "__main__":
    line = ReadFile("model_i5_openloop_Vec_1130.txt")
    ...
    plt.title('模板定位-开环验证姿态定位精度测试结果', weight='bold', fontproperties=my_font, fontsize=14)
    plt.grid()
    ...
    plt.legend(loc='best')
    plt.tight_layout()
    plt.savefig('模板定位-开环验证姿态定位精度测试结果-向量夹角法.png')
    plt.show()
