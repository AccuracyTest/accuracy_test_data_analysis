...
if __name__ == "__main__":
    line = ReadFile("char_i5_openloop_Vec_1130.txt")
    ...
    plt.title('特征码定位-开环验证姿态定位精度测试结果', weight='bold', fontproperties=my_font, fontsize=14)
    plt.grid()
    ...
    plt.legend(loc='best')
    plt.tight_layout()
    plt.savefig('特征码定位-开环验证姿态定位精度测试结果-向量夹角法.png')
    plt.show()
